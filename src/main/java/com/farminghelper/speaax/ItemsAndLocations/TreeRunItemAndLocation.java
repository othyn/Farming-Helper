...
public class TreeRunItemAndLocation extends ItemAndLocation
{
    ...
    public void setupLocations()
    {
        ...
        setupFossilIslandEast();
        setupFossilIslandSouth();
        setupFossilIslandWest();
    ...
    private void setupFossilIslandEast()
    {
        WorldPoint fossilIslandEastTreePatchPoint = new WorldPoint(
            3715,
            3835,
            0
        );

        fossilIslandEastTreeLocation = new Location(
        ...
        fossilIslandEastTreeLocation.addTeleportOption(fossilIslandEastTreeLocation.new Teleport(
            "Digsite_pendant",
            ...
            1,
            13365,
            fossilIslandEastTreePatchPoint,
        ...
        locations.add(fossilIslandEastTreeLocation);
    }

    private void setupFossilIslandSouth()
    {
        WorldPoint fossilIslandSouthTreePatchPoint = new WorldPoint(
            3708,
            3833,
            0
        );

        fossilIslandSouthTreeLocation = new Location(
            FarmingHelperConfig::optionEnumFossilIslandSouthTeleport,
            config,
            "Fossil Island",
            false
        );

        fossilIslandSouthTreeLocation.addTeleportOption(fossilIslandSouthTreeLocation.new Teleport(
            "Digsite_pendant",
            Location.TeleportCategory.ITEM,
            "Teleport to the Digsite with the Digsite Pendant, then Quick-Travel on the easterly barge and run to the Fossil Island hardwood tree patches via the beach tunnel",
            ItemID.DIGSITE_PENDANT_1,
            ...
            1,
            13365,
            fossilIslandSouthTreePatchPoint,
            Collections.singletonList(new ItemRequirement(
                ItemID.DIGSITE_PENDANT_1,
                1
            ))
        ...
        locations.add(fossilIslandSouthTreeLocation);
    }

    private void setupFossilIslandWest()
    {
        WorldPoint fossilIslandWestTreePatchPoint = new WorldPoint(
            3702,
            3837,
            0
        );

        fossilIslandWestTreeLocation = new Location(
            FarmingHelperConfig::optionEnumFossilIslandWestTeleport,
            config,
            "Fossil Island",
            false
        );

        fossilIslandWestTreeLocation.addTeleportOption(fossilIslandWestTreeLocation.new Teleport(
            "Digsite_pendant",
            Location.TeleportCategory.ITEM,
            "Teleport to the Digsite with the Digsite Pendant, then Quick-Travel on the easterly barge and run to the Fossil Island hardwood tree patches via the beach tunnel",
            ItemID.DIGSITE_PENDANT_1,
            ...
            1,
            13365,
            fossilIslandWestTreePatchPoint,
            Collections.singletonList(new ItemRequirement(
                ItemID.DIGSITE_PENDANT_1,
                1
            ))
        ...
        locations.add(fossilIslandWestTreeLocation);
    }
