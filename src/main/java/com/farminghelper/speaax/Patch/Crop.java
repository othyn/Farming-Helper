...
public enum Crop
{
    ...
    APPLE(
        ...
        IntStream.rangeClosed( 14, 20), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
    ...
    BANANA(
        ...
        IntStream.rangeClosed( 41, 47), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
    ...
    ORANGE(
        ...
        IntStream.rangeClosed( 78, 84), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
    ...
    CURRY(
        ...
        IntStream.rangeClosed(105,111), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
    ...
    PINEAPPLE(
        ...
        IntStream.rangeClosed(142,148), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
    ...
    PAPAYA(
        ...
        IntStream.rangeClosed(169,175), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
    ...
    PALM(
        ...
        IntStream.rangeClosed(206,212), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
    ...
    DRAGONFRUIT(
        ...
        IntStream.rangeClosed(233,239), // harvestable - tree[Inspect,Guide,Chop-down,Pick-{fruit}]
